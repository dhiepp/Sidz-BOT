...
module.exports = {
	...
	execute(message) {
		...
		const hours = Math.floor((uptime % 86400) / 3600).padStart(2, '0');
		const minutes = Math.floor((uptime % 3600) / 60).padStart(2, '0');
		const seconds = Math.floor(uptime % 60).padStart(2, '0');
